...
from botconfig import shelve_name, database_name
...
"""
использование ключевого слова with : оно позволяет не заморачиваться 
о закрытии хранилища, Python сам возьмет на себя управление.
"""
